...
const PINYIN_FREQUENCY: Record<string, string> = {
  ...
  "派": "pai4",    // to send/dispatch/faction (pā = only in 派司 loanword, rare)
  ...
  // ── Additional common polyphonic characters (new entries only, no duplicates) ─────
  "传": "chuan2",  // to pass on / to spread (zhuàn = biography, less common standalone)
  "调": "diao4",   // to transfer / to tune (tiáo = to adjust, both common but diao4 more frequent)
  "参": "can1",    // to participate / ginseng (shēn = ginseng plant, only in 人参)
  "便": "bian4",   // convenient / then (pián = cheap, only in 便宜)
  "背": "bei4",    // to carry on back / to recite (bēi = to carry on back, both common)
  "处": "chu3",    // to deal with / to be in (chù = place, both very common)
  "答": "da2",     // to answer (dā = to agree/respond, less common standalone)
  "倒": "dao4",    // to fall / to pour (dǎo = to fall over, both common)
  "干": "gan4",    // to do / to work (gān = dry, both common)
  "供": "gong4",   // to offer / to supply (gōng = to supply, both common)
  "冠": "guan4",   // champion / first place (guān = hat/crown, both common)
  "号": "hao4",    // number / name (háo = to howl, rare standalone)
  "华": "hua2",    // China / magnificent (Huà = surname, less common)
  "活": "huo2",    // to live / alive (huó = single dominant reading)
  "积": "ji1",     // to accumulate (jī = single dominant reading)
  "记": "ji4",     // to remember / to record (jì = single dominant reading)
  "降": "jiang4",  // to descend / to lower (xiáng = to surrender, less common standalone)
  "尽": "jin3",    // to the utmost / as much as possible (jìn = to exhaust, both common)
  "劲": "jin4",    // strength / energy (jìng = strong, less common standalone)
  "空": "kong1",   // empty / sky (kòng = free time/gap, both common)
  "量": "liang4",  // to measure (liáng = to measure, both common)
  "落": "luo4",    // to fall / to land (là = to leave behind, both common)
  "模": "mo2",     // model / pattern (mú = mold/template, less common standalone)
  "宁": "ning4",   // would rather (níng = peaceful, both common)
  "泡": "pao4",    // bubble / to soak (pāo = to throw, less common standalone)
  "破": "po4",     // broken / to break (pò = single dominant reading)
  "曲": "qu3",     // song / tune (qū = bent/winding, less common standalone)
  "散": "san4",    // to scatter / to disperse (sǎn = loose/scattered, both common)
  "扇": "shan4",   // fan / to fan (shān = to fan, both common)
  "舍": "she3",    // to give up / to abandon (shè = house/dormitory, both common)
  "似": "si4",     // to seem / to resemble (shì = only in 似的, rare)
  "宿": "su4",     // to stay overnight (xiù = constellation, less common standalone)
  "缩": "suo1",    // to shrink / to contract (suō = single dominant reading)
  "提": "ti2",     // to carry / to raise / to mention (tí = single dominant reading)
  "贴": "tie1",    // to stick / to paste (tiē = single dominant reading)
  "通": "tong1",   // to connect / to go through (tòng = ache, rare standalone)
  "吐": "tu4",     // to vomit (tǔ = to spit out, both common)
  "系": "xi4",     // system / to tie (jì = to tie, less common standalone)
  "鲜": "xian1",   // fresh / delicious (xiǎn = rare, only in 朝鲜)
  "相": "xiang1",  // mutually / each other (xiàng = appearance/photo, both common)
  "兴": "xing4",   // interest / excitement (xīng = to prosper, less common standalone)
  "血": "xue4",    // blood (xiě = blood, dialectal)
  "压": "ya1",     // to press / to suppress (yā = single dominant reading)
  "载": "zai4",    // to carry / to load (zǎi = year/to record, both common)
  "增": "zeng1",   // to increase (zēng = single dominant reading)
  "折": "zhe2",    // to fold / to break (shé = to break, less common standalone)
  "正": "zheng4",  // correct / upright (zhēng = first month, rare standalone)
  "转": "zhuan3",  // to turn / to rotate (zhuǎn = to turn; zhuàn = to revolve, both common)
  "装": "zhuang1", // to install / to dress up (zhuāng = single dominant reading)
  "撞": "zhuang4", // to collide / to bump into (zhuàng = single dominant reading)
  "总": "zong3",   // always / total / general (zǒng = single dominant reading)
};
