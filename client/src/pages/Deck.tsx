...
function FlashCard({
  ...
  // Track the measured height of the back face so the card container can grow to fit it
  ...
  // Spacebar shortcut: flip card if not flipped, trigger Know if already flipped
  useEffect(() => {
    ...
    <div className="flex flex-col w-full text-center">
      ...
      <div className="px-6 pb-4 border-t border-border/30 pt-4 text-left">
        ...
        <ul className="space-y-1.5">
          {formatFlashcardDefinitions(word.simpleDefinition, word.otherMeanings).map((item, i) => (
